package com.depth.behavior.behavior.lear;
...
import com.depth.behavior.behavior.HeaderBehavior;
import com.depth.behavior.behavior.ViewOffsetBehavior;

import java.util.List;

/**
 * The {@link CoordinatorLayout.Behavior} for a scrolling view that is positioned vertically below another view. See
 * {@link HeaderBehavior}.
 */
public abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public boolean onMeasureChild(@NonNull CoordinatorLayout parent, @NonNull View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
        ...
        if (childLpHeight == ViewGroup.LayoutParams.MATCH_PARENT || childLpHeight == ViewGroup.LayoutParams.WRAP_CONTENT) {
            // 如果菜单的高度设置为match_parent/wrap_content，那么使用最大可见高度来测量它
